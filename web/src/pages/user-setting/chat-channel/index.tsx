...
const AvailableChannelCard = ({
  ...
  return (
    <article
      className="
        size-full p-3 border-0.5 border-border-button rounded-xl relative group cursor-pointer transition-colors hover:bg-bg-card focus-within:bg-bg-card
...
const ChatChannel = () => {
  ...
  return (
    <UserSettingPageWrapper>
      <UserSettingBreadcrumb label={t('setting.chatChannels')} />
          ...
          <div className="h-full p-5 overflow-x-hidden overflow-y-auto">
            <section className="flex flex-col gap-3">
              {categorizedList?.length <= 0 && (
                <div className="text-text-secondary w-full flex justify-center items-center h-20 rounded-xl bg-bg-card">
            ...
            <section className="mt-8">
              <header className="flex flex-row items-center justify-between space-y-0 p-0 pb-4">
                <h2 className="text-2xl font-medium text-text-primary">
                  ...
                  <span className="block text-sm text-text-secondary font-normal mt-1.5">
