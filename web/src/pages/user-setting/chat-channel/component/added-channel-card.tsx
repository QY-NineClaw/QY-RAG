...
export const AddedChannelCard = (props: IAddedChannelCardProps) => {
  ...
  return (
    <Card className="bg-transparent border border-border-button px-5 pt-[10px] pb-5 rounded-xl shadow-none">
      ...
      <CardContent className="p-2 flex flex-col gap-2">
        {list.map((item) => (
          <div
            key={item.id}
            className="flex flex-row items-center justify-between rounded-xl bg-bg-card px-3 py-4"
          >
